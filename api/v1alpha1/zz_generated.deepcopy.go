...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RoutingBuilder) DeepCopyInto(out *RoutingBuilder) {
	*out = *in
	if in.Routing != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RoutingBuilder.
func (in *RoutingBuilder) DeepCopy() *RoutingBuilder {
	if in == nil {
		return nil
	}
	out := new(RoutingBuilder)
	in.DeepCopyInto(out)
	return out
}
